    ...
    <div class="container-fluid">
        ...
        <div class="navbar-brand">
            <a href="#" class="d-inline-flex align-items-center">
                <img src="{{ asset('dashboard/images/logo_icon.svg') }}" alt="">
                <img src="{{ asset('dashboard/images/logo_text_light.svg') }}" class="d-none d-sm-inline-block h-16px ms-3" alt="">
            </a>
        </div>
            ...
            <li class="nav-item nav-item-dropdown-lg dropdown">
                <a href="#" class="navbar-nav-link align-items-center rounded p-1" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="status-indicator-container">
                        <img src="{{ asset('dashboard/images/demo/users/face11.jpg') }}" class="w-32px h-32px rounded" alt="">
